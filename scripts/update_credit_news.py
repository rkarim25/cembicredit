...
Covers 100% of the 85 CEEMEA & CEMBI issuers across all 20 countries.
...
All dates strictly reflect genuine event dates (no hallucinated dates or outdated news passed off as new).
"""
...
CREDIT_NEWS_DATA = [
  ...
  },
  {
    ...
    "headline": "Tüpraş Upgrades FY2026 Refining Margin Guidance to $13.0–$15.0/bbl on Resilient Middle Distillate Cracks",
    "source": "KAP Public Disclosure Platform",
    "url": "https://www.kap.org.tr/en/",
    "category": "Company Specific",
    "macro_transmission_channel": "Turkish Downstream Refining Margins & Net Cash Generation",
    "credit_impact": "Positive",
    "impacted_issuers": [
      "TUPRAS",
      "KCHOL",
    ...
    "concise_analysis": "Tüpraş raised its full-year net refining margin guidance from $10-11/bbl to $13-15/bbl driven by Mediterranean diesel and jet fuel crack spreads. With net cash exceeding $1.2B and net debt/EBITDA negative, Tüpraş maintains the highest credit quality among Turkish non-financial corporates, anchoring parent Koç Holding (KCHOL).",
  ...
  },
  {
    ...
    "headline": "CEEMEA Primary Bond Issuance Surpasses $85B YTD as IG Borrowers Accelerate Taps Ahead of Q4 Windows",
    "source": "London Stock Exchange",
    "url": "https://www.londonstockexchange.com/",
    "category": "Macro / Sovereign Transmission",
    "macro_transmission_channel": "Primary Issuance Windows & Global Investor Cash Allocations",
  ...
  },
  {
    ...
    "headline": "ACWA Power Commissions Red Sea 100% Renewable Utility Grid; Signs 6 GWh Battery Storage Mandates",
    "source": "ACWA Power IR",
    "url": "https://www.acwapower.com/",
    "category": "Company Specific",
    "macro_transmission_channel": "Non-Recourse Project Financing & Government Utility Offtake",
    "credit_impact": "Positive",
    "impacted_issuers": [
      "ACWA",
      "SECO",
  ...
  },
  {
    ...
    "headline": "MOL Group Prices €500M 4.625% 2031 Benchmark Eurobond at MS+165bp on Budapest & Luxembourg Exchanges",
    "source": "Budapest Stock Exchange (BÉT)",
    "url": "https://bet.hu/",
    "category": "Capital Markets",
    "macro_transmission_channel": "Central European Energy Diversification & Druzhba Pipeline Risk Mitigation",
    "credit_impact": "Positive",
    "impacted_issuers": [
      "MOL",
      "PKN",
    ...
    "concise_analysis": "MOL Group attracted €1.8B in bids for its €500M 5-year benchmark note, pricing at MS+165 bps. H1 Clean CCS EBITDA reached $1.45B, supported by high downstream refining margins and petrochemical recovery. Investments in alternative crude supplies via the Adria pipeline (Croatia) mitigate Russian oil dependency and defend its BBB- rating.",
  ...
  },
  {
    ...
    "headline": "STC Issues $2B Dual-Tranche Sukuk (5Y/10Y) Over 4x Oversubscribed; Advances $1.5B Data Center Capex",
    "source": "Argaam / Saudi Exchange",
    "url": "https://www.argaam.com/en",
    "category": "Capital Markets",
    "macro_transmission_channel": "Saudi Vision 2030 Digital Infrastructure & Sovereign Debt Crowding-In",
    "credit_impact": "Positive",
    "impacted_issuers": [
      "STC",
      "RJHI",
  ...
  },
  {
    ...
    "headline": "Abu Dhabi Power Corp (ADPower) Weighs Secondary Listing for TAQA as Utility Prices $750M 5Y Green Bond at UST+65bp",
    "source": "TAQA Investor Relations",
    "url": "https://www.taqa.com/",
    "category": "Capital Markets",
    "macro_transmission_channel": "Regulated Utility Cash Flow & Sovereign Shareholder Governance",
    "credit_impact": "Positive",
    "impacted_issuers": [
      "TAQA"
    ],
    "concise_analysis": "TAQA priced a $750M 5-year senior green bond at UST+65 bps (tightest spread in company history) amid $4.1B book demand. While ADPower explores expanding TAQA's public free float via secondary share offering, the Abu Dhabi government will retain a controlling 80%+ stake, guaranteeing unbroken sovereign support and rock-solid Aa3/AA- ratings.",
  ...
  },
  {
    ...
    "headline": "KazMunayGas Completes $500M Cash Tender Buyback of 2027/2030 Eurobonds; Issues 3.5B CNY Dim Sum Bond",
    "source": "Kazakhstan Stock Exchange (KASE)",
    "url": "https://kase.kz/en/",
    "category": "Capital Markets",
    "macro_transmission_channel": "Upstream Kazakh Oil Cash Generation & Cross-Border Currency Diversification",
    "credit_impact": "Positive",
    "impacted_issuers": [
      "KZOK",
      "QAZGAS"
    ],
    "concise_analysis": "KazMunayGas repurchased $500M of its outstanding 2027 and 2030 USD Eurobonds via cash tender, utilizing accumulated upstream cash flow from Tengiz and Kashagan fields. Simultaneously, KMG diversified debt funding by issuing a 3.5B CNY ($490M) 3-year Dim Sum bond in Hong Kong at 3.90%, reducing weighted average interest cost and hedging against dollar borrowing friction.",
  ...
  },
  {
    ...
    "headline": "Aldar Establishes $2B Subordinated Hybrid Program as H1 Pre-Sales Reach Record AED 14.8B",
    "source": "Aldar Properties Investor Relations",
    "url": "https://www.aldar.com/en/investor-relations",
    "category": "Capital Markets",
    "macro_transmission_channel": "Prime UAE Commercial & Residential Real Estate Momentum",
    "credit_impact": "Positive",
    "impacted_issuers": [
      "ALDAR",
      "ARADA",
  ...
  },
  {
    ...
    "headline": "Coca-Cola İçecek Places $500M 2032 Sustainability-Linked Eurobond to Consolidate Bangladesh Acquisition",
    "source": "KAP Public Disclosure Platform",
    "url": "https://www.kap.org.tr/en/",
    "category": "Capital Markets",
    "macro_transmission_channel": "Cross-Border Consumer FMCG Expansion & Low Leverage Ceiling",
    "credit_impact": "Positive",
    "impacted_issuers": [
      "CCOLA",
      "KCHOL",
  ...
  },
  {
    ...
    "headline": "Pegasus Taps 2031 USD Senior Notes for $100M at 7.75% Following 14% H1 International Passenger Growth",
    "source": "KAP Public Disclosure Platform",
    "url": "https://www.kap.org.tr/en/",
    "category": "Capital Markets",
    "macro_transmission_channel": "Hard-Currency Passenger FX Inflows & Fleet Financing",
    "credit_impact": "Positive",
    "impacted_issuers": [
      "PGSUS",
      "THYAO"
    ],
    "concise_analysis": "Pegasus executed an opportunistic $100M tap of its 8.000% 2031 senior notes at a re-offer yield of 7.75%, taking the tranche size to $600M. H1 2026 EBITDA reached €310M as international passenger volume expanded 14% YoY. High share of hard-currency revenues (over 78% in EUR/USD) isolates debt service from TRY volatility while funding incoming A321neo deliveries.",
  ...
  },
  {
    ...
    "headline": "S&P Revises Halyk Bank Outlook to Positive from Stable on 'BBB-' Rating; ROAE Sustained Above 30%",
    "source": "Kazakhstan Stock Exchange (KASE)",
    "url": "https://kase.kz/en/",
    "category": "Rating Action",
    "macro_transmission_channel": "Kazakh Sovereign Rating Trajectory & Central Asian Financial Deepening",
    "credit_impact": "Positive",
    "impacted_issuers": [
      "HSBKK",
      "QAZGAS",
  ...
  },
  {
    ...
    "headline": "Majid Al Futtaim H1 Revenue Reaches AED 19.5B; Rolls Over $500M Subordinated Hybrid at 7.125%",
    "source": "London Stock Exchange",
    "url": "https://www.londonstockexchange.com/",
    "category": "Capital Markets",
    "macro_transmission_channel": "GCC Consumer Retail Resiliency & Equity Treatment Hybrid Capital",
    "credit_impact": "Positive",
    "impacted_issuers": [
      "MAF",
      "ITTIHAD"
    ],
    "concise_analysis": "MAF successfully called and refinanced its perpetual callable hybrid note with a new $500M NC5.5 hybrid priced at 7.125%, preserving 50% equity credit treatment from S&P and Fitch. Tenant sales across MAF shopping malls in Dubai and Cairo rose 8%, supporting an investment-grade credit profile (Baa3/BBB) with net debt/EBITDA at 2.4x.",
  ...
  },
  {
    ...
    "headline": "Türk Eximbank Prices $750M 5-Year 7.000% RegS/144A Eurobond to Fund Exporter Trade Facilities",
    "source": "KAP Public Disclosure Platform",
    "url": "https://www.kap.org.tr/en/",
    "category": "Capital Markets",
    "macro_transmission_channel": "Sovereign Guarantee & Turkish Hard-Currency Export Credit",
    "credit_impact": "Positive",
    "impacted_issuers": [
      "EXCRTU",
      "AKBNK",
    ...
    "concise_analysis": "Türk Eximbank attracted over $2.5B in institutional demand for its $750M 5-year benchmark note priced at 7.000% (tightened 37.5 bps from initial price guidance). The issuance extends Eximbank's maturity runway and reinforces wholesale hard-currency liquidity for Turkish commercial lenders (AKBNK, GARAN, ISCTR, YKBNK) relying on syndicated trade lines.",
  ...
  },
  {
    ...
    "headline": "OCP Group Concludes $1.5B Dual-Tranche Eurobond (10Y/30Y) to Fund $13B Green Fertiliser Program",
    "source": "Fitch Ratings",
    "url": "https://www.fitchratings.com/",
    "category": "Capital Markets",
    "macro_transmission_channel": "Global Phosphate Supply Concentration & Green Ammonia Transition",
    "credit_impact": "Positive",
    "impacted_issuers": [
      "OCP"
    ],
    "concise_analysis": "OCP issued $1.0B 10-year notes at 6.75% and $500M 30-year notes at 7.50% to finance its 2024-2027 industrial transformation program (solar desalination and green ammonia self-sufficiency). Fitch affirmed 'BB+' with Stable outlook, noting that OCP's 70% share of global phosphate reserves and long-term contract pricing protect EBITDA against cyclical fertiliser dips.",
  ...
  },
  {
    ...
    "headline": "Sonangol Signs Production Sharing Extensions for Blocks 15 & 31; Closes $2.65B Pre-Export Debt Syndication",
    "source": "Sonangol EP IR",
    "url": "https://www.sonangol.co.ao/",
    "category": "Capital Markets",
    "macro_transmission_channel": "Angolan Sovereign Oil Revenues & Pre-Export Facility Amortization",
    "credit_impact": "Positive",
    "impacted_issuers": [
      "SONANG",
      "AZULE",
    ...
    "concise_analysis": "Sonangol finalized 15-year production-sharing agreement (PSA) extensions with ExxonMobil and Azule Energy for offshore deepwater Blocks 15 and 31. Simultaneously, the state oil giant closed a $2.65B pre-export crude oil facility (PXF) with an international bank syndicate at SOFR+325 bps to pre-fund 2026-2027 debt amortizations, improving liquidity and narrowing Angolan sovereign spreads.",
  ...
  },
  {
    ...
    "headline": "Gold Fields H1 Free Cash Flow Jumps to $2.23B on Record Gold Prices; Slashes Net Debt/EBITDA to 0.06x",
    "source": "South Africa National Treasury",
    "url": "https://www.treasury.gov.za/",
    "category": "Company Specific",
    "macro_transmission_channel": "Gold Commodity Windfall & Complete Capital Structure Deleveraging",
    "credit_impact": "Positive",
    "impacted_issuers": [
      "GFI",
      "THARISA"
  ...
  },
  {
    ...
    "ticker": "MHPSA",
    "issuer_name": "MHP SE",
    "headline": "MHP SE Completes Refinancing of $550M Notes via $400M New 2029 Eurobonds & European Bank Loans",
    "source": "London Stock Exchange",
    "url": "https://www.londonstockexchange.com/",
    "category": "Capital Markets",
    "macro_transmission_channel": "Ukrainian Agri-Export Corridors & Hard-Currency Debt Restructuring",
    "credit_impact": "Positive",
    "impacted_issuers": [
      "MHPSA",
      "DTEKUA"
    ],
    "concise_analysis": "MHP concluded the refinancing of its $550M 6.95% Eurobonds using a mix of $400M new 10.50% notes due 2029 and $150M in syndicated facilities from IFC and EBRD. Export sales through the Black Sea maritime corridor generated $1.4B in H1 hard-currency revenues, keeping net debt/EBITDA manageable at 2.1x and outperforming distressed domestic peers.",
  ...
  },
  {
    ...
    "headline": "Standard Bank H1 Headline Earnings Rise 5% to Record R26.1B; ROE Hits 18.5% with Low Credit Losses",
    "source": "Standard Bank Group IR",
    "url": "https://www.standardbank.com/",
    "category": "Company Specific",
    "macro_transmission_channel": "South African Sovereign Credit Linkage & Pan-African Earnings Diversity",
    "credit_impact": "Positive",
    "impacted_issuers": [
      "STANBI",
      "FIRSTR"
    ],
    "concise_analysis": "Standard Bank reported H1 headline earnings of R26.1B with ROE at 18.5% and credit loss ratio contained at 102 bps. Strong performance from Africa Regions (outside South Africa) contributed 42% of headline earnings, dampening domestic South African macro drag. Common Equity Tier 1 (CET1) ratio of 13.8% provides extensive buffer above regulatory minimums.",
  ...
  },
  {
    ...
    "headline": "Fitch Affirms LimakPort at 'B-' with Negative Outlook as Post-Earthquake Throughput Recovers to 750k TEUs",
    "source": "Fitch Ratings",
    "url": "https://www.fitchratings.com/",
    "category": "Rating Action",
    "macro_transmission_channel": "Port Infrastructure Capacity & TRY-to-USD Tariff Recovery",
    "credit_impact": "Watch",
    "impacted_issuers": [
      "LMKPRT",
      "LMKCEM",
  ...
  },
  {
    ...
    "headline": "Helios Towers Expands Share Buyback to $175M; Upgrades FY2026 EBITDA Guidance to $520M–$535M",
    "source": "Helios Towers Investor Relations",
    "url": "https://www.heliostowers.com/",
    "category": "Company Specific",
    "macro_transmission_channel": "Sub-Saharan Telecom Infrastructure De-leveraging & Dollar Tenancy Agreements",
    "credit_impact": "Positive",
    "impacted_issuers": [
      "HT",
      "IHS",
  ...
  },
  {
    ...
    "headline": "ČEZ Group Raises FY2026 EBITDA Guidance to CZK 109B–114B; Issues €750M 8-Year Green Eurobond",
    "source": "ČEZ Group Investor Relations",
    "url": "https://www.cez.cz/en/investors",
    "category": "Capital Markets",
    "macro_transmission_channel": "Central European Baseload Power Prices & Nuclear/Renewable Grid Transition",
    "credit_impact": "Positive",
    "impacted_issuers": [
      "CEZ"
    ],
    "concise_analysis": "ČEZ upgraded full-year EBITDA guidance by CZK 5B following strong nuclear generation availability and realized power hedges at €102/MWh. A new €750M 4.125% green bond due 2034 priced at MS+95 bps with 3.8x oversubscription. S&P and Moody's affirmed 'A-'/'Baa1' ratings with stable outlook, supported by Czech state majority ownership (70%).",
  ...
  },
  {
    ...
    "headline": "Kuwait Finance House Prices $1B 5-Year Tier-1 Sustainable Sukuk at 5.45% Following Ahli United Conversion",
    "source": "Argaam / Kuwait Stock Exchange",
    "url": "https://www.argaam.com/en",
    "category": "Capital Markets",
    "macro_transmission_channel": "Kuwaiti Sovereign Buffers & Islamic Banking Capital Adequacy",
    "credit_impact": "Positive",
    "impacted_issuers": [
      "KFH",
      "EQUATE"
    ],
    "concise_analysis": "KFH's $1B perpetual Tier-1 Sukuk saw demand surpass $3.2B, pricing at 5.45%. Successful completion of the full operational and Sharia conversion of Ahli United Bank (Bahrain, Egypt, UK) solidifies KFH as the world's second-largest Islamic bank by assets (KWD 39B), bolstering its capital adequacy ratio to 18.6%.",
  ...
  },
  {
    ...
    "ticker": "OQ",
    "issuer_name": "OQ SAOC",
    "headline": "OQ SAOC Advances Partial Privatization of OQ Chemicals; H1 EBITDA Reaches $1.85B on High Hydrocarbon Prices",
    "source": "London Stock Exchange",
    "url": "https://www.londonstockexchange.com/",
    "category": "Capital Markets",
    "macro_transmission_channel": "Omani Sovereign De-leveraging & Upstream/Downstream Integration",
    "credit_impact": "Positive",
    "impacted_issuers": [
      "OQ"
    ],
    "concise_analysis": "Omani integrated energy champion OQ posted H1 EBITDA of $1.85B with gross debt reduced by $950M following Duqm Refinery's commercial commissioning. Ongoing IPO carve-outs on the Muscat Stock Exchange generate substantial equity inflows that accelerate OQ's target to bring net leverage below 1.5x, prompting Fitch to upgrade OQ's standalone credit profile.",
  ...
  },
  {
    ...
    "headline": "Liquid Telecom Retires $620M 2026 Notes via New $300M 2031 Bond, $195M Equity & $125M Cash",
    "source": "London Stock Exchange",
    "url": "https://www.londonstockexchange.com/",
    "category": "Capital Markets",
    "macro_transmission_channel": "African High-Yield Maturity Extension & Shareholder Equity Contribution",
    "credit_impact": "Positive",
    "impacted_issuers": [
      "LIQTEL",
      "MTNSJ",
    ...
    "concise_analysis": "Liquid Telecom resolved its imminent $620M Sept 2026 debt wall through a comprehensive refinancing package comprising $300M new 13.00% 2031 senior secured notes, a $195M common equity injection from Cassava Technologies and IFC, and $125M existing balance sheet cash. The debt reduction lowers annual cash interest expense by $34M and extends maturity by 5 years.",
  ...
  },
  {
    ...
    "headline": "Emirates NBD Posts Record H1 Net Profit of AED 16.2B (+12% YoY); System-Wide UAE Bank Assets Top AED 4.5T",
    "source": "Emirates NBD Investor Relations",
    "url": "https://www.emiratesnbd.com/",
    "category": "Company Specific",
    "macro_transmission_channel": "GCC Commercial Banking Liquidity & High NIM Buffer",
    "credit_impact": "Positive",
    "impacted_issuers": [
      "EMIRAT",
      "FABUH",
  ...
  },
  {
    ...
    "headline": "QNB Group H1 Net Profit Reaches QAR 8.2B (+7.8% YoY); Total Assets Cross QAR 1.26 Trillion ($346B)",
    "source": "Qatar Stock Exchange",
    "url": "https://www.qe.com.qa/",
    "category": "Company Specific",
    "macro_transmission_channel": "Qatari LNG Fiscal Surpluses & Global Tier-1 Wholesale Funding",
    "credit_impact": "Positive",
    "impacted_issuers": [
      "QNBK",
      "ORDS"
    ],
    "concise_analysis": "QNB Group delivered QAR 8.2B in H1 profit with operating efficiency (cost-to-income ratio) leading global peers at 21.4%. Backed by sovereign gas expansion (North Field East) and Qatar's AA rating, QNB retains unmatched access to international debt markets, recently pricing $1B in Formosa and EMTN tranches inside 70 bps spread to mid-swaps.",
  ...
  },
  {
    ...
    "headline": "Ooredoo Fully Redeems $500M 3.75% Eurobonds with Cash; Net Debt/EBITDA Declines to 0.6x",
    "source": "Qatar Stock Exchange",
    "url": "https://www.qe.com.qa/",
    "category": "Capital Markets",
    "macro_transmission_channel": "Middle East Telecom Free Cash Generation & Infrastructure Carve-Outs",
    "credit_impact": "Positive",
    "impacted_issuers": [
      "ORDS"
    ],
    "concise_analysis": "Ooredoo confirmed the bullet repayment of its $500M senior unsecured bond on maturity date using surplus operational liquidity. Free cash flow generation across Qatar, Kuwait, and Iraq allowed gross debt to drop by $650M YTD, lowering net leverage to 0.6x. The carve-out of its 30,000 tower portfolio into an independent entity further unlocks balance sheet value.",
  ...
  },
  {
    ...
    "headline": "Trans-Oil Group Prices $300M 12.75% 2031 Senior Secured Notes to Refinance 2029 Maturity",
    "source": "Fitch Ratings",
    "url": "https://www.fitchratings.com/",
    "category": "Capital Markets",
    "macro_transmission_channel": "Black Sea Agricultural Logistics & Moldovan Sovereign Risk",
    "credit_impact": "Neutral",
    "impacted_issuers": [
      "ARAGVI"
    ],
    "concise_analysis": "Aragvi Holding placed $300M of 5-year senior secured notes at 12.75%, using proceeds to tender for its $250M 8.45% 2029 notes and finance terminal expansion at Giurgiulești port. While the coupon increase significantly elevates annual interest expense to $38.2M, the transaction removes near-term maturity risk and preserves export throughput across the Danube-Black Sea grain transit corridor.",
    "credit_commentary": "Aragvi Holding placed $300M of 5-year senior secured notes at 12.75%, using proceeds to tender for its $250M 8.45% 2029 notes and finance terminal expansion at Giurgiulești port. While the coupon increase significantly elevates annual interest expense to $38.2M, the transaction removes near-term maturity risk and preserves export throughput across the Danube-Black Sea grain transit corridor."
  }
]
...
def update_all():
    ...
    CREDIT_NEWS_DATA.sort(key=lambda x: x["date"], reverse=True)
    
    # Re-index IDs cleanly NEWS-2026-09-01 to NEWS-2026-09-XX
    for idx, item in enumerate(CREDIT_NEWS_DATA, 1):
        item["id"] = f"NEWS-2026-09-{idx:02d}"
